...
% given initial set
Q0 = (diag([0.03,0.03,0.03,0.03,0.03,0.03,0.001,0.001])^2);
...
args = struct('max_iter', 1, 'ftol', 5e-4, 'plot_cost', true,...
...
tic
% [res_lp, cost_lp, rate_lp] = funnel_nonlinear_lp4(sys, t(1:2), Q0, [2,2,2,1,1,1,0,0], zeros(1,11), 2*ones(1,8), args);
[res_lp, cost_lp, rate_lp] = funnel_nonlinear_lp4(sys, t(1:2), Q0, [2,2,2,1,1,1,0,0], zeros(1,11), 2*ones(1,8), args);
ctime_all_lp = toc;
